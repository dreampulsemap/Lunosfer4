...
fun TimelinePanel(
    ...
    Row(
        ...
        clips.forEach { clip ->
            val widthDp = (clip.trimmedDurationMs / MS_PER_DP).coerceAtLeast(32L).toInt().dp
            ...
            Box(
                ...
                Icon(
                    ...
                    contentDescription = null, tint = Color.White.copy(alpha = 0.85f), modifier = Modifier.size(16.dp),
                )
            }
        }
        Box(
